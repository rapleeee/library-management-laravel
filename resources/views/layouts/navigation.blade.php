  ...
  <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700">
         ...
         @if (Auth::user()->role == 'admin')
          <li>
              ...
              <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                  ...
                  <li>
                      <a href="{{route('books.history')}}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Informasi</a>
                  </li>
              </ul>
          </li>
          <li>
          ...
          <li>
              ...
              <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                  ...
                  <li>
                      <a href="{{route('anggota.create')}}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Riwayat Pinjaman Buku</a>
                  </li>
                  <li>
                      <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Informasi</a>
                  </li>
          ...
          <li>
              ...
              <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                  <li>
                      <a href="{{route('profile.edit')}}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Edit Profile</a>
                  </li>
              </ul>
          </li>
      </ul>
      <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
          ...
          <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit">
                    <span class="ml-3 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group">Keluar</span>
            </button>
          </form>
          </li>
      </ul>
